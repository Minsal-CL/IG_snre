...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest">
      <sch:assert test="count(f:extension[@url = 'https://interoperabilidad.minsal.cl/fhir/ig/snre/StructureDefinition/ProdComercial']) &lt;= 1">extension with URL = 'https://interoperabilidad.minsal.cl/fhir/ig/snre/StructureDefinition/ProdComercial': maximum cardinality of 'extension' is 1</sch:assert>
