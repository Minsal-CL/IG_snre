// Originally defined on lines 1 - 223
...
* dosageInstruction.doseAndRate.doseRange.low.value MS
* dosageInstruction.doseAndRate.doseRange.low.unit MS
* dosageInstruction.doseAndRate.doseRange.low.system MS
* dosageInstruction.doseAndRate.doseRange.low.code MS
* dosageInstruction.doseAndRate.doseRange.high MS
* dosageInstruction.doseAndRate.doseRange.high.value MS
* dosageInstruction.doseAndRate.doseRange.high.unit MS
* dosageInstruction.doseAndRate.doseRange.high.system MS
* dosageInstruction.doseAndRate.doseRange.high.code MS
* identifier MS
* identifier 0..1
...
* statusReasonCodeableConcept.coding MS
* statusReasonCodeableConcept.coding.system MS
* statusReasonCodeableConcept.coding.code MS
* statusReasonCodeableConcept.coding.display MS
* statusReasonCodeableConcept.text MS
...
* authorizingPrescription.reference MS
...
* dosageInstruction.sequence 1..1
* dosageInstruction.sequence MS
...
* dosageInstruction.route.coding.code ^short = "Código de la via por medio de subset de SNOMED-CT"
* dosageInstruction.route.coding.code ^definition = "Código de la via por medio de subset de SNOMED-CT"
...
* performer contains
    Dispensador 0.. and
    Validador 0..
* performer[Dispensador] 1..1
* performer[Validador] 0..1
...
* performer[Dispensador].function MS
* performer[Dispensador].function.coding MS
* performer[Dispensador].function.coding.system MS
* performer[Dispensador].function.coding.code MS
* performer[Dispensador].actor MS
* performer[Dispensador].actor.reference MS
* performer[Dispensador].actor.display MS
...
* performer[Validador].function MS
* performer[Validador].function.coding MS
* performer[Validador].function.coding.system MS
* performer[Validador].function.coding.code MS
* performer[Validador].actor MS
* performer[Validador].actor.reference MS
* performer[Validador].actor.display MS
...
* detectedIssue MS
* detectedIssue.display MS
* detectedIssue.reference MS
...
// Originally defined on lines 226 - 283
...
// Originally defined on lines 286 - 313
...
* performer[Dispensador].function = http://receta.minsal.gob.cl/Tablas/TablaFunc#Dispensador "Dispensador"
...
* performer[Validador].function = http://receta.minsal.gob.cl/Tablas/TablaFunc#Validador "Validador"
* performer[Validador].actor = Reference(https://api-receta.minsal.cl/v2/Practitioner/2309028611) "NICOLÁS ALEXIS SOTO DURÁN"
